...
LOGIN = os.getenv("EMAIL")#بريدك الالكنروني
PASSWORD = os.getenv("PASSWORD")#كلمة السر
...
def main_operation(code, t):
    ...
    try:
        ...
        #driver.quit()
            ...
            print(f"حدث خطأ: {e}")
            for i in admin:
                bot.send_message(i, "حدث خطاء يرجي عمل تحديث للسيرفر ومعاودة المحاولة مرة اخرى")
        finally:
            bot.send_message(i, "حدث خطاء يرجي عمل تحديث للسيرفر ومعاودة المحاولة مرة اخرى")
            driver.quit()
